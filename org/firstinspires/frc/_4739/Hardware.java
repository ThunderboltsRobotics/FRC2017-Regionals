...
//			private static final MotorEncoder aimEncoder = new MotorEncoder(0);
	...
	static void initialize() {
		if (!Motors.Drive.rightA.isReversed()) {
			Motors.Drive.rightA.reverse();
		}
		if (!Motors.Drive.rightB.isReversed()) {
			Motors.Drive.rightB.reverse();
		}
		if (!Motors.Shooter.right.isReversed()) {
			Motors.Shooter.right.reverse();
		}
	}
